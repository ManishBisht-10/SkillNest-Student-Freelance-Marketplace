  ...
  return (
    <div className="space-y-5">
      <section className="rounded-2xl border border-secondary/70 bg-secondary/20 p-5">
        <h1 className="font-heading text-3xl font-bold">Consumer Contracts</h1>
        <p className="mt-1 text-sm text-text/70">Review submissions and approve completed work.</p>
      </section>
