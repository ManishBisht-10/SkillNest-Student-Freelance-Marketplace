...
const navItems = [
  ...
  { to: "/consumer/post-job", label: "Post Job" },
  { to: "/consumer/jobs", label: "My Jobs" },
  { to: "/consumer/contracts", label: "Contracts" },
  { to: "/consumer/chat", label: "Chat" },
      ...
      <header className="sticky top-0 z-20 border-b border-secondary/80 bg-primary/95 backdrop-blur">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-3 md:px-6">
          ...
          <div className="flex items-center gap-3">
            <p className="hidden text-sm text-text/70 md:block">{user?.name || "Consumer"}</p>
